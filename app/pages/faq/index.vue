  ...
  <div class="bg-gray-100">
    <header class="text-gray-500 bg-gray-800 body-font top-0 left-0 right-0 absolute">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <a href="#" class="mr-5 text-gray-200 hover:text-white">FAQ</a>
        </nav>
        <a
          href="#"
    ...
    <footer class="text-gray-500 bg-gray-800 body-font">
      <div class="container px-5 py-8 mx-auto flex items-center">
        <a href="www.ndow.org" class="title-font font-medium text-white">
...
#hero {
  background-image:
    ...
    url(https://source.unsplash.com/qNhstTawQrI/1600x900);
